...
void InitMysteryGameScene()
{
	...
	LoadTexture("Res/ì‰Ç©ÇØÉQÅ[ÉÄ/Ç†Ç¢Ç§Ç¶Ç®.png", TEXTURE_MYSTERY, MysteryGameCategoryTextureList::MysteryGameBgMax);
	LoadTexture("Res/ì‰Ç©ÇØÉQÅ[ÉÄ/Ç†Ç¢Ç§Ç¶Ç®òg.png", TEXTURE_MYSTERY, MysteryGameCategoryTextureList::MysteryGameTextBoxMax);
	LoadTexture("Res/ì‰Ç©ÇØÉQÅ[ÉÄ/ëIëíÜ.png", TEXTURE_MYSTERY, MysteryGameCategoryTextureList::MysteryGameChoiceTextMax);
