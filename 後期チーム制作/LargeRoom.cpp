...
void InitLargeRoomScene()
{
	...
	LoadTexture("Res/ëÂïîâÆB.png", TEXTURE_SEARCH, SearchCategoryTextureList::SearchBgTex);
		
	LoadTexture("Res/íTçıÉQÅ[ÉÄ/åÆ.png", TEXTURE_SEARCH_GAME, SearchGameCategoryTextureList::SearchGameItemKeyTex);

	LoadTexture("Res/â∆ãÔ/äœótêAï®B.png", TEXTURE_SEARCH, SearchCategoryTextureList::SearchFlowerpot);
	LoadTexture("Res/â∆ãÔ/ÉRÅ[Égä|ÇØ.png", TEXTURE_SEARCH, SearchCategoryTextureList::Searchhanger);
